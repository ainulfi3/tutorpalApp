...
// loadNavHeader() – Function loads the navigation drawer header
// information like profile image, name and website. Here we use Glide
// image library to load the profile image.
